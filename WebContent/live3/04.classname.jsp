...
<h1 class="no4">Head Line no 4</h1>
<h1 class="no1">Head Line no 5</h1>
<button onclick="javascript:byClassName('no1');">getElementsByClassName(no1)</button>
<button onclick="javascript:byClassName('no2');">getElementsByClassName(no2)</button>
<!-- here end -->
