...
<script type="text/javascript">
	function byQuerySelectorAll(className) {
		let tagColor;
		if(className == "no1"){
			tagColor = "pink";
		} else {
		...
		for(let i=0; i<classes.length; i++){
			classes[i].style.backgroundColor = tagColor;
		}
	}
</script>
...
<button onclick="javascript:byQuerySelectorAll('no1');">querySelectorAll(no1)</button>
<button onclick="javascript:byQuerySelectorAll('no2');">querySelectorAll(no2)</button>
<!-- here end -->
