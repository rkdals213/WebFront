...
<script type="text/javascript">
	function byQuerySelectorAll(tagName) {
		let tagColor;
		if(tagName == "h2"){
			tagColor = "pink";
		} else {
		...
		for(let i=0; i<tags.length; i++){
			tags[i].style.backgroundColor = tagColor;
		}
	}
</script>
...
<button onclick="javascript:byQuerySelectorAll('h1');">querySelectorAll(h1)</button>
<button onclick="javascript:byQuerySelectorAll('h2');">querySelectorAll(h2)</button>
<!-- here end -->
