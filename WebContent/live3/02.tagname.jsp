...
<button onclick="javascript:byTagName('h1');">getElementsByTagName(h1)</button>
<button onclick="javascript:byTagName('h2');">getElementsByTagName(h2)</button>
<!-- here end -->
