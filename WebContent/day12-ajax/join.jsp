...
$(document).ready(function() {
	$("#registerBtn").click(function() {		
		if($("#name").val() == "") {
			...
			$("#memberform").attr("action", "${root}/main.do").submit();
		}
	});
...
<body>
<div class="super_container" align="center">
	<h1>회원가입</h1>
	<div class="col-lg-6" align="center">
		<form id="memberform" method="post" action="">
		<input type="hidden" name="act" id="act" value="register">
			<div class="form-group" align="left">
				<label for="name" class="tag tag_house">이름</label>
				<input type="text" class="form-control" id="name" name="name" placeholder="">
			</div>
			<div class="form-group" align="left">
				<label for="" class="hot_title">아이디</label>
			...
			<div class="form-group" align="left">
				...
				<div id="address" class="custom-control-inline">
			...
			<div class="form-group" align="center">
				<button type="button" class="search_button" id="registerBtn">회원가입</button>
